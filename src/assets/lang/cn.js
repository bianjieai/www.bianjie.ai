    ...
    "product": {
        ...
        "txt": [
            ...
            },
            {
                ...
                "txt": "<div>区块链智能信息边缘分析网络BEAN，是基于 <a style='color: #72ACE3' href='https://www.irisnet.org' target='_blank'>IRISnet</a> 技术为大数据分析打造的分布式智能信息分析和数据交换网络，通过AI和区块链技术释放数据价值，支持数据可信分析和交换。</div>" +
